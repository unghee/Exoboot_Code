...
if not config.READ_ONLY:
    for exo in exo_list:
        standing_angle = exo.standing_calibration(config)
...
while True:
    try:
        ...
        for exo in exo_list:
            exo.read_data(config, loop_time=loop_time)
            print("Did heel strike", exo.data.did_heel_strike)
        ...
        for exo in exo_list:
            exo.write_data(config, only_write_if_new=only_write_if_new)
